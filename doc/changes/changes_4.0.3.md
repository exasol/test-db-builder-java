# Test Database Builder for Java 4.0.3, released 2026-09-15
...
* #169: Fixed vulnerability CVE-2026-86231 in dependency `com.github.mwiede:jsch:jar:2.28.5:test`

## Dependency Updates

### Test Dependency Updates

* Updated `com.exasol:exasol-jdbc:26.2.7` to `26.2.9`
* Updated `com.exasol:exasol-testcontainers:8.0.1` to `8.0.2`
* Updated `com.exasol:hamcrest-resultset-matcher:1.7.2` to `1.7.3`
* Updated `com.mysql:mysql-connector-j:9.7.0` to `26.7.0`
* Updated `com.oracle.database.jdbc:ojdbc11:23.26.2.0.0` to `23.26.3.0.0`
* Updated `org.postgresql:postgresql:42.7.12` to `42.7.13`
